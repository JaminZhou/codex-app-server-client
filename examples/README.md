...
In this source checkout, the three safety examples and numbered groups 01–14 and 16 use the **real bundled Codex 0.155.1 app-server**,
...
| Symptom | Recovery |
| --- | --- |
| npm returns 404 for the scoped package | Check `npm view @jaminzhou/codex-app-server-client@0.2.2 version --registry https://registry.npmjs.org/`. If unavailable, use a verified local candidate. Check network access; do not infer publication from a source version or substitute the unscoped package. |
