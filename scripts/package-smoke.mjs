...
const manifest = withSmokeCleanup(temporaryRoot, () => {
  ...
  writeFileSync(join(temporaryRoot, "consumer.mts"), [
    ...
    'const memory: v2.MemoryStatusResponse = await client.call("memory/status", {});',
    'const attachment: v2.ThreadAttachmentAddResponse = await client.call("thread/attachment/add", { threadId: "thread", attachmentType: "fixture", identityKey: "key", payload: {} });',
    'await client.call("thread/attachment/list", { threadId: "thread" });',
    'await client.call("thread/attachment/remove", { threadId: "thread", attachmentType: "fixture", identityKey: "key" });',
    'await client.call("userVerification/cancel", { requestId: "verification" });',
