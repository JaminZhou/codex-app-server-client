...
Current pinned runtime and protocol baseline: `@openai/codex@0.147.0`
(`codex-cli 0.147.0` / `rust-v0.147.0`), including its generated experimental surface. See
...
- Provides a fully typed `call()` API for all 136 client methods in the pinned protocol.
