...
Current pinned runtime and protocol baseline: `@openai/codex@0.150.1`
(`codex-cli 0.150.1` / `rust-v0.150.1`), including its generated experimental surface. See
...
- Provides a fully typed `call()` API for all 156 client methods in the pinned protocol.
