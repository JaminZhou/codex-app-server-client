...
export type ExternalAgentConfigImportHistory = { importId: string, completedAtMs: number | bigint, successes: Array<ExternalAgentConfigImportItemTypeSuccess>, failures: Array<ExternalAgentConfigImportItemTypeFailure>, };
