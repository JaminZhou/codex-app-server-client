...
5. Refresh the public method map:
...
The generator rejects non-exact CLI versions, mismatched method-map versions, missing methods, extra methods, and missing generated response types.
