...
Current pinned runtime and protocol baseline: `@openai/codex@0.152.1`
(`codex-cli 0.152.1` / `rust-v0.152.1`), including its generated experimental surface. See
...
- Provides a fully typed `call()` API for all 157 client methods in the pinned protocol.
