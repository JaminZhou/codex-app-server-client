...
| --- | --- | --- |
| Public Codex CLI | `codex-cli 0.146.1` / `rust-v0.146.1` | Runtime binary and public app-server behavior |
...
`compatibility-matrix.json`, currently `0.146.0` and the pinned `0.146.1`. On the minimum supported
